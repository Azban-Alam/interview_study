...
public class Imp_Method_ReplaceAll {
	public static void main(String[] args) {

		String text = "Order123 shipped on 2026-04-16";
		String result = text.replaceAll("\\d", "*");// Replace all digits with "*"
		...
		String result2 = text2.replaceAll("\\b\\w+at\\b", "animal");// Replace all words ending with 'at' with 'animal'
